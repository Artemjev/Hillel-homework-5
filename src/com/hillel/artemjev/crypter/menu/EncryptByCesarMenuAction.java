...
public class EncryptByCesarMenuAction implements MenuAction {
    private StringCrypter stringCrypter;
    private Scanner scanner;

    public EncryptByCesarMenuAction(StringCrypter stringCrypter, Scanner scanner) {
    ...
    public void doAction() {
        System.out.println("\n*********************************");
        System.out.println("Шифрование шифром Цезаря");
